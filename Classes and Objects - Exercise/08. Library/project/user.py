...
class User:
    ...
    def get_book(self, author, book_name, days_to_return, library):
        if library.books_available:
            for curr_author, curr_books in library.books_available.items():
                if curr_author == author and book_name in curr_books:
